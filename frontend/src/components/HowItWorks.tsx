  ...
  const steps = [
    {
      ...
      description:
        "Tell MoodMuse how you feel and select an emotion that matches your current vibe.",
    },
    {
      icon: "🌍",
    ...
    },
    {
      ...
      description:
        "MoodMuse analyzes your emotion and finds music that matches your feeling.",
    },
    {
      icon: "🎧",
      title: "Get Your Song",
    ...
    <section className="mx-auto max-w-7xl px-6 py-16">
      ...
      <div className="text-center">
        ...
        <p
          ...
          `}
        >
          MoodMuse combines emotions, AI, and music to create a
