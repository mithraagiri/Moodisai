  ...
  const features = [
    {
      ...
      title: "AI Powered",
      description:
        "MoodMuse understands your emotions and recommends music that matches your current mood.",
    },
    ...
    >
      ...
      <div className="text-center">
        ...
        <p
          ...
          `}
        >
          MoodMuse is an AI-powered music discovery platform that understands
          ...
          MoodMuse creates your personal emotional soundtrack.
        </p>
